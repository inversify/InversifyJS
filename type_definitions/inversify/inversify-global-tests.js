...
var global_module_test;
(function (global_module_test) {
    var Katana = (function () {
        function Katana() {
        }
    ...
    var Samurai = (function () {
        ...
        Samurai = __decorate([
            ...
            __param(0, inversify.tagged("canThrow", false)),
            __param(1, inversify.tagged("canThrow", true)), 
            __metadata('design:paramtypes', [Object, Object])
        ], Samurai);
        return Samurai;
    }());
    ...
    var throwable = inversify.tagged("canThrow", true);
    var notThrowable = inversify.tagged("canThrow", false);
    ...
    var Samurai3 = (function () {
        ...
        Samurai3 = __decorate([
            inversify.inject("IWeapon", "IWeapon"),
            __param(0, inversify.named("strong")),
            __param(1, inversify.named("weak")), 
            __metadata('design:paramtypes', [Object, Object])
        ], Samurai3);
        return Samurai3;
    }());
...
})(global_module_test || (global_module_test = {}));
