...
interface BindingWhenSyntax<T> {
    ...
    whenInjectedInto(parent: interfaces.ServiceIdentifierOrArray<any>): interfaces.BindingOnSyntax<T>;
    ...
    whenAnyAncestorIs(ancestor: interfaces.ServiceIdentifierOrArray<any>): interfaces.BindingOnSyntax<T>;
    whenNoAncestorIs(ancestor: interfaces.ServiceIdentifierOrArray<any>): interfaces.BindingOnSyntax<T>;
