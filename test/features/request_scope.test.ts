...
describe('inRequestScope', () => {
  it('Should support request scope in basic bindings', () => {
    ...
    class Samurai implements Warrior {
      ...
      public constructor(@inject(TYPE.Weapon) primaryWeapon: Weapon, @inject(TYPE.Weapon) secondaryWeapon: Weapon) {
  ...
  it('Should support request scope when using contraints', () => {
    ...
    container.bind<Weapon>(TYPE.Weapon).to(Katana).inRequestScope().whenTargetNamed('sword');

    container.bind<Weapon>(TYPE.Weapon).to(Shuriken).inRequestScope().whenTargetNamed('throwable');
