...
import { Container, inject, injectable, multiInject, named, optional, tagged, unmanaged } from '../../src/inversify';
...
describe('Property Injection', () => {
  ...
  it('Should be able to inject a property combined with constructor injection', () => {
    ...
    class Samurai implements Warrior {
      ...
      public constructor(@inject(TYPES.Weapon) @named(TAGS.Primary) weapon: Weapon) {
        this.name = 'Samurai';
