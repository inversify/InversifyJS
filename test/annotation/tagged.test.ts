...
class TaggedWarrior {
	...
	public constructor(@tagged('power', 1) primary: Weapon, @tagged('power', 2) secondary: Weapon) {
...
describe('@Tagged', () => {
	...
	it('Should throw when applied multiple times', () => {
		...
		const useDecoratorMoreThanOnce = function () {
			__decorate(
				[__param(0, tagged(metadataKey, 1)), __param(0, tagged(metadataKey, 2))],
	...
	it('Should be usable in VanillaJS applications', () => {
		const VanillaJSWarrior = (function () {
			function TaggedVanillaJSWarrior() {
				// ...
			}
