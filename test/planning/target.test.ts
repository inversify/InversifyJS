...
describe("Target", () => {
    ...
    it("Should be able to create instances of untagged tagets", () => {
        let target = new Target(TargetType.ConstructorArgument, "katana", "Katana");
    ...
    it("Should be able to create instances of named tagets", () => {
        let target = new Target(TargetType.ConstructorArgument, "katana", "Katana", "primary");
        expect(target.serviceIdentifier).to.be.eql("Katana");
        expect(target.name.value()).to.be.eql("katana");
        expect(Array.isArray(target.metadata)).to.be.eql(true);
    ...
    it("Should be able to create instances of tagged tagets", () => {
        let target = new Target(TargetType.ConstructorArgument, "katana", "Katana", new Metadata("power", 5));
        expect(target.serviceIdentifier).to.be.eql("Katana");
        expect(target.name.value()).to.be.eql("katana");
        expect(Array.isArray(target.metadata)).to.be.eql(true);
        expect(target.metadata.length).to.be.eql(1);
    ...
    it("Should be able to identify named metadata", () => {
        let target1 = new Target(TargetType.ConstructorArgument, "katana", "Katana", "primary");
        expect(target1.isNamed()).to.be.eql(true);
        let target2 = new Target(TargetType.ConstructorArgument, "katana", "Katana", new Metadata("power", 5));
        expect(target2.isNamed()).to.be.eql(false);
    });

    it("Should be able to identify multi-injections", () => {
        let target1 = new Target(TargetType.ConstructorArgument, "katana", "Katana");
        target1.metadata.push(new Metadata(METADATA_KEY.MULTI_INJECT_TAG, "Katana"));
        expect(target1.isArray()).to.be.eql(true);
        let target2 = new Target(TargetType.ConstructorArgument, "katana", "Katana");
    ...
    it("Should be able to identify tagged metadata", () => {
        ...
        let target1 = new Target(TargetType.ConstructorArgument, "katana", "Katana", new Metadata("power", 5));
        expect(target1.isTagged()).to.be.eql(true);

        let target2 = new Target(TargetType.ConstructorArgument, "katana", "Katana", "primary");
        expect(target2.isTagged()).to.be.eql(false);

        let target3 = new Target(TargetType.ConstructorArgument, "katana", "Katana");
