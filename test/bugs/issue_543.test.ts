...
describe('Issue 543', () => {
  it('Should throw correct circular dependency path', () => {
    ...
    class Child2 {
      ...
      public constructor(@inject(TYPE.Circular) circ: Circular) {
        this.circ = circ;
      }
    }
    ...
    class Child {
      ...
      public constructor(@inject(TYPE.Irrelevant) irrelevant: Irrelevant, @inject(TYPE.Child2) child2: Child2) {
    ...
    class Circular {
      public irrelevant: Irrelevant;
      public child: Child;
      public constructor(@inject(TYPE.Irrelevant) irrelevant: Irrelevant, @inject(TYPE.Child) child: Child) {
        this.irrelevant = irrelevant;
        this.child = child;
      }
    }
    ...
    class Root {
      public irrelevant: Irrelevant;
      public circ: Circular;
      public constructor(@inject(TYPE.Irrelevant) irrelevant1: Irrelevant, @inject(TYPE.Circular) circ: Circular) {
