...
export const ARGUMENTS_LENGTH_MISMATCH = (...values: string[]): string =>
...
export const POST_CONSTRUCT_ERROR = (...values: string[]): string => `@postConstruct error in class ${values[0]}: ${values[1]}`;

export const CIRCULAR_DEPENDENCY_IN_FACTORY = (...values: string[]): string =>
