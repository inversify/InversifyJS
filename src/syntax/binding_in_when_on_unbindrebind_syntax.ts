...
class BindingInWhenOnUnbindRebindSyntax<T> implements interfaces.BindingInWhenOnUnbindRebindSyntax<T>  {
    ...
    public inRequestScope(): interfaces.BindingWhenOnUnbindRebindSyntax<T> {
        return this._bindingSyntaxFactory.getBindingIn().inRequestScope();
    }

    public inSingletonScope(): interfaces.BindingWhenOnUnbindRebindSyntax<T> {
        return this._bindingSyntaxFactory.getBindingIn().inSingletonScope();
    }

    public inTransientScope(): interfaces.BindingWhenOnUnbindRebindSyntax<T> {
        return this._bindingSyntaxFactory.getBindingIn().inTransientScope();
    }
...
export { BindingInWhenOnUnbindRebindSyntax };
