...
export const ensureFullyBound = (binding: interfaces.Binding<unknown>): void => {
...
export const getFactoryDetails = (binding: interfaces.Binding<unknown>): interfaces.FactoryDetails => {
    switch(binding.type){
        case BindingTypeEnum.Factory:
